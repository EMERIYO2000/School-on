...
class CommunityLike(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['user', 'thread'], name='unique_user_thread_like'),
            models.UniqueConstraint(fields=['user', 'post'], name='unique_user_post_like'),
            models.CheckConstraint(
                condition=(models.Q(thread__isnull=False) & models.Q(post__isnull=True)) |
                          (models.Q(thread__isnull=True) & models.Q(post__isnull=False)),
                name='like_targets_one_community_item',
            ),
        ]
