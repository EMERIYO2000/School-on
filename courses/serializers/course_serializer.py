...
from ..models import (
    ...
    LessonProgress, QuizAttempt, AttemptAnswer
)
...
class QuizSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'shuffle_choices', 'status', 'xp_reward', 'questions',
        ]
...
class QuizCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'shuffle_questions', 'shuffle_choices', 'xp_reward', 'questions',
        ]
        read_only_fields = ['id']
...
class CourseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'price', 'is_premium', 'is_state_exam_prep', 'status', 'review_note', 'reviewed_at', 'created_at'
        ]
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'unassigned_lessons', 'quizzes', 'is_enrolled'
        ]
